...
public class XjlTPaymentRequestModel extends BaseModel {
	...
	private String processInstIdTwo;
	...
	public String getProcessInstIdTwo() {
		return processInstIdTwo;
	}

	public void setProcessInstIdTwo(String processInstIdTwo) {
		this.processInstIdTwo = processInstIdTwo;
	}
