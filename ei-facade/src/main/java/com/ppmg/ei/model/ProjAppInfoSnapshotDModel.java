...
public class ProjAppInfoSnapshotDModel extends BaseModel {
	...
	/** null */
	private Double beforeValuation;

	/** null */
	private String beforeValuationCurrency;

	/** null */
	private Double afterValuation;

	/** null */
	private String afterValuationCurrency;
	...
	public Double getBeforeValuation() {
		return beforeValuation;
	}

	public void setBeforeValuation(Double beforeValuation) {
		this.beforeValuation = beforeValuation;
	}

	public String getBeforeValuationCurrency() {
		return beforeValuationCurrency;
	}

	public void setBeforeValuationCurrency(String beforeValuationCurrency) {
		this.beforeValuationCurrency = beforeValuationCurrency;
	}

	public Double getAfterValuation() {
		return afterValuation;
	}

	public void setAfterValuation(Double afterValuation) {
		this.afterValuation = afterValuation;
	}

	public String getAfterValuationCurrency() {
		return afterValuationCurrency;
	}

	public void setAfterValuationCurrency(String afterValuationCurrency) {
		this.afterValuationCurrency = afterValuationCurrency;
	}
