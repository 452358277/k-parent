...
public class AdminListModel extends BaseModel {
	...
	/** 资产信息*/
	private AdminAssetModel adminAssetModel;

	/** 股东信息*/
	private List<AdminPartnerModel> adminPartnerModels;

	private  String isCooName;
	...
	public AdminAssetModel getAdminAssetModel() {
		return adminAssetModel;
	}

	public void setAdminAssetModel(AdminAssetModel adminAssetModel) {
		this.adminAssetModel = adminAssetModel;
	}

	public List<AdminPartnerModel> getAdminPartnerModels() {
		return adminPartnerModels;
	}

	public void setAdminPartnerModels(List<AdminPartnerModel> adminPartnerModels) {
		this.adminPartnerModels = adminPartnerModels;
	}

	public String getIsCooName() {
		return isCooName;
	}

	public void setIsCooName(String isCooName) {
		this.isCooName = isCooName;
	}
