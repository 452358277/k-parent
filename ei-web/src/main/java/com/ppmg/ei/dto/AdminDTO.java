...
public class AdminDTO extends BaseDTO {
	...
	/** 资产信息*/
	private AdminAssetDTO adminAssetDTO;

	/** 股东信息*/
	private List<AdminPartnerDTO> adminPartnerDTOS;
	...
	public AdminAssetDTO getAdminAssetDTO() {
		return adminAssetDTO;
	}

	public void setAdminAssetDTO(AdminAssetDTO adminAssetDTO) {
		this.adminAssetDTO = adminAssetDTO;
	}

	public List<AdminPartnerDTO> getAdminPartnerDTOS() {
		return adminPartnerDTOS;
	}

	public void setAdminPartnerDTOS(List<AdminPartnerDTO> adminPartnerDTOS) {
		this.adminPartnerDTOS = adminPartnerDTOS;
	}
