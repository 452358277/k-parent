...
@Scope("prototype")
@Api(tags={"XXX接口"})
public class FundQuitAssessController extends BaseAction{

	protected final Logger logger = LoggerFactory.getLogger(this.getClass());

	@Reference
	private FundQuitAssessService fundQuitAssessService;
	...
	@GetMapping(value = "/XXX1Info/{id}", produces = "application/json;charset=UTF-8")
	@ResponseBody
	public String detail(@PathVariable(value = "id") String id){
		try {
			FundQuitAssessModel model = fundQuitAssessService.selectById(id);
