...
@ApiModel(value = "基金考核列表", description = "基金考核列表")
public class PerfScoreVO extends BaseVO {
    //主键id
    private String psId;
    //关联主表id
    ...
    private String psOneselfYesnoName;
    //是否考核（0草稿，1考核）
    private String psAssessYesno;
    private String psAssessYesnoName;
    //附件
    ...
    public String getPsOneselfYesnoName() {
        return psOneselfYesnoName;
    }

    public void setPsOneselfYesnoName(String psOneselfYesnoName) {
        this.psOneselfYesnoName = psOneselfYesnoName;
    }

    public String getPsAssessYesnoName() {
        return psAssessYesnoName;
    }

    public void setPsAssessYesnoName(String psAssessYesnoName) {
        this.psAssessYesnoName = psAssessYesnoName;
    }
