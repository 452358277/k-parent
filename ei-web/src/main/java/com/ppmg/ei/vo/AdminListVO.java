...
public class AdminListVO extends BaseVO {
	...
	/** 资产信息*/
	private AdminAssetVO adminAssetVO;


	/** 股东信息*/
	private List<AdminPartnerVO> adminPartnerVOS;
	...
	public AdminAssetVO getAdminAssetVO() {
		return adminAssetVO;
	}

	public void setAdminAssetVO(AdminAssetVO adminAssetVO) {
		this.adminAssetVO = adminAssetVO;
	}

	public List<AdminPartnerVO> getAdminPartnerVOS() {
		return adminPartnerVOS;
	}

	public void setAdminPartnerVOS(List<AdminPartnerVO> adminPartnerVOS) {
		this.adminPartnerVOS = adminPartnerVOS;
	}
