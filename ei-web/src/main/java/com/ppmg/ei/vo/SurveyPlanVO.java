...
@Data
public class SurveyPlanVO extends BaseVO {
    ...
    private List<SurveyPlanUsersModel> list;

    private String planUserNames;

    List<SurverCooorgModel> listSurverCooorg;
    ...
    private DueDiligenceRptModel dueDiligenceRpt;
